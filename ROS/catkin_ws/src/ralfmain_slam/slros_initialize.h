...
extern SimulinkSubscriber<geometry_msgs::PoseWithCovarianceStamped, SL_Bus_RALFMain_SLAM_PoseWithCovarianceStamped_l4ivcs> Sub_RALFMain_SLAM_1247;
...
extern SimulinkParameterArrayGetter<char_T, std::string> ParamGet_RALFMain_SLAM_1266;
