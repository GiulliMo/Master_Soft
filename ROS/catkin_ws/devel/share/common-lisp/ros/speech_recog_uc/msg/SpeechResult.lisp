...
(cl:defmethod cl:initialize-instance :after ((m <SpeechResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SpeechResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name speech_recog_uc-msg:<SpeechResult> is deprecated: use speech_recog_uc-msg:SpeechResult instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SpeechResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader speech_recog_uc-msg:result-val is deprecated.  Use speech_recog_uc-msg:result instead.")
  (result m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <SpeechResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader speech_recog_uc-msg:confidence-val is deprecated.  Use speech_recog_uc-msg:confidence instead.")
  (confidence m))
