...
if("TRUE" STREQUAL "TRUE")
  set(statemachine_SOURCE_PREFIX /home/alf/catkin_ws2/src/statemachine)
  set(statemachine_DEVEL_PREFIX /home/alf/catkin_ws2/devel)
  ...
  set(statemachine_INSTALL_PREFIX /home/alf/catkin_ws2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'statemachine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alf/catkin_ws2/src/statemachine/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND statemachine_EXPORTED_TARGETS ${${statemachine_dep}_EXPORTED_TARGETS})
endforeach()
