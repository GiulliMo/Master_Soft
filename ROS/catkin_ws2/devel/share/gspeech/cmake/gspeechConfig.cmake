...
if("TRUE" STREQUAL "TRUE")
  set(gspeech_SOURCE_PREFIX /home/alf/catkin_ws2/src/hmi_robin/gspeech)
  set(gspeech_DEVEL_PREFIX /home/alf/catkin_ws2/devel)
  set(gspeech_INSTALL_PREFIX "")
  set(gspeech_PREFIX ${gspeech_DEVEL_PREFIX})
else()
  set(gspeech_SOURCE_PREFIX "")
  set(gspeech_DEVEL_PREFIX "")
  set(gspeech_INSTALL_PREFIX /home/alf/catkin_ws2/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/gspeech " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/gspeech' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'achuwilsonGEC Sreekrishnapuram+91-9400418468 <achu@achuwilson.in>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gspeech' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alf/catkin_ws2/src/hmi_robin/gspeech/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gspeech_NUM_DUMMY_TARGETS)
      set(gspeech_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gspeech::wrapped-linker-option${gspeech_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gspeech_NUM_DUMMY_TARGETS "${gspeech_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gspeech::wrapped-linker-option${gspeech_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gspeech_LIBRARIES "${interface_target_name}")
