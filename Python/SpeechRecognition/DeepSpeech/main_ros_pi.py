...
## python audio_streamy -di 7 -nn audio -tp audio_stream auf ALF PC um ROS-Message mit Audio Inhalt zu streamen
## python3 main_ros.py -r 5 -lm gb -tpp recognition -tps audio_stream -nn recognizer auf Pi ausfuehren
