...
## Daten Laden
ground_truth = nlp.loadJsons("ground_truthDeepSpeech_DataII.json")
hypothesis = nlp.loadJsons("hypothesisDeepSpeech_DataII.json")
labelsTask = nlp.loadJsons("labelsTaskDeepSpeech_DataII.json")
processingtime = nlp.loadJsons("processingtimeDeepSpeech_DataII.json")
confidence = []
