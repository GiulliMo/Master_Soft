...
runNode(r,'ralfcanread');
r.CatkinWorkspace='~/catkin_ws';
runNode(r,'joy');

%joy_node wird gestartet
                                                  %RALFCANsend_node wird gestartet
%runNode(r,'RALFJoystick17b');                                                 %RALFJoystick_node wird gestartet
...
gpidv=gpi2;%(gpv+giv);%Gpi
gpidh=gpi2;%(gph+gih);%Gpi
