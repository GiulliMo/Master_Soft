###########################################################################
## Makefile generated for Simulink model 'MecanumPose'. 
## 
## Makefile     : MecanumPose.mk
## Generated on : Sun Mar 22 11:21:02 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MecanumPose.elf
...
PRODUCT_NAME              = MecanumPose
MAKEFILE                  = MecanumPose.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2019b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/giull/Desktop/Master_Soft/Simulink/MecanumPose170320
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MecanumPose.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/MecanumPose_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/aeroblks/aeroblks -I$(MATLAB_ROOT)/toolbox/aero/aero/src -I$(MATLAB_ROOT)/toolbox/ros/slros/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=MecanumPose -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MecanumPose.cpp.o MecanumPose_data.cpp.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.cpp.o slros_busmsg_conversion.cpp.o slros_initialize.cpp.o slros_generic_param.cpp.o
...
%.c.o : $(START_DIR)/MecanumPose_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/MecanumPose_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/MecanumPose_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ert_main.cpp.o : $(START_DIR)/MecanumPose_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


MecanumPose.cpp.o : $(START_DIR)/MecanumPose_ert_rtw/MecanumPose.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


MecanumPose_data.cpp.o : $(START_DIR)/MecanumPose_ert_rtw/MecanumPose_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/MecanumPose_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/MecanumPose_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
