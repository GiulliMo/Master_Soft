...
void b_commandNet_0::setup()
{
  ...
  (dynamic_cast<MWElementwiseAffineLayer *>(this->layers[1]))
    ...
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_imageinput_scale.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_imageinput_offset.bin",
    1);
  (dynamic_cast<MWFusedConvReLULayer *>(this->layers[2]))
    ...
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_1_w.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_1_b.bin",
    0);
  ...
  (dynamic_cast<MWFusedConvReLULayer *>(this->layers[4]))
    ...
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_2_w.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_2_b.bin",
    0);
  ...
  (dynamic_cast<MWFusedConvReLULayer *>(this->layers[6]))
    ...
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_3_w.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_3_b.bin",
    0);
  ...
  (dynamic_cast<MWFusedConvReLULayer *>(this->layers[8]))
    ...
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_4_w.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_4_b.bin",
    0);
  (dynamic_cast<MWFusedConvReLULayer *>(this->layers[9]))
    ->createFusedConvReLULayer(this->targetImpl, 1, this->layers[8]
    ->getOutputTensor(0), 3, 3, 48, 48, 1, 1, 1, 1, 1, 1, 1, 1, 1,
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_5_w.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_conv_5_b.bin",
    1);
  ...
  (dynamic_cast<MWFCLayer *>(this->layers[12]))->createFCLayer(this->targetImpl,
    ...
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_fc_w.bin",
    "/home/alf/Schreibtisch/Master_Soft/Simulink/Spracherkennung/codegen/mex/test/cnn_commandNet_fc_b.bin",
    1);
