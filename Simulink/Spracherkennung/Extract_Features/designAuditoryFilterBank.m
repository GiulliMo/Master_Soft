function [filterBank,Fc,BW] = designAuditoryFilterBank(fs,varargin)
...
params     =  audio.internal.AuditoryFilterBankValidator(fs,varargin{:});
...
if strcmp(params.FrequencyScale,'erb')
    ...
    [fbank,Fc,FFTLengthTooSmall] = audio.internal.designMelFilterBank( ...
    ...
    if  FFTLengthTooSmall && isempty(coder.target)
        warning(message('audio:melspectrogam:FFTLengthTooSmall'));
    end
end
