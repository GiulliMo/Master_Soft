...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sdf_target.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sdf_target.elf
...
%.c.o : $(START_DIR)/sdf_target_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/sdf_target_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/sdf_target_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
