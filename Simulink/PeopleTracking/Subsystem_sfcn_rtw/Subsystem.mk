...
MODEL                   = Subsystem
MODULES                 = 
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Subsystem_sf.mexmaci64
MAKEFILE                = Subsystem.mk
MATLAB_ROOT             = /Applications/MATLAB_R2020a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2020a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Users/HannesDittmann/Documents/Studium/Master\ Business\ and\ Systems\ Engineering/3.Semester/Masterarbeit/Software/Master_Soft/Simulink/PeopleTracking
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = MACI64
BUILDARGS               =  CREATEMODEL=1 USEPARAMVALUES=0 OPTS="-DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.9"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
DEFINES_CUSTOM          = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2020a.app/bin/maci64" -lut -lfixedpoint
